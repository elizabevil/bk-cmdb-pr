...
func init() {
	...
	registerIndexes(common.BKTableNameChartConfig, deprecatedChartConfigIndexes)
	registerIndexes(common.BKTableNameChartConfig, commChartConfigIndexes)

}

//  新加和修改后的索引,索引名字一定要用对应的前缀，CCLogicUniqueIdxNamePrefix|common.CCLogicIndexNamePrefix

var commChartConfigIndexes = []types.Index{}
