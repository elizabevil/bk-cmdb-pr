...
func init() {
	...
	registerIndexes(common.BKTableNameCloudSyncTask, deprecatedCloudSyncTaskIndexes)
	registerIndexes(common.BKTableNameCloudSyncTask, commCloudSyncTaskIndexes)

}

//  新加和修改后的索引,索引名字一定要用对应的前缀，CCLogicUniqueIdxNamePrefix|common.CCLogicIndexNamePrefix

var commCloudSyncTaskIndexes = []types.Index{}
