...
func init() {
	...
	registerIndexes(common.BKTableNameNetcollectProperty, deprecatedNetcollectPropertyIndexes)
	registerIndexes(common.BKTableNameNetcollectProperty, commNetcollectPropertyIndexes)

}

//  新加和修改后的索引,索引名字一定要用对应的前缀，CCLogicUniqueIdxNamePrefix|common.CCLogicIndexNamePrefix

var commNetcollectPropertyIndexes = []types.Index{}
...
var deprecatedNetcollectPropertyIndexes = []types.Index{
	{
		...
		Keys: bson.D{{
			Key: "netcollect_property_id", Value: 1},
		},
		Background: true,
	},
	{
