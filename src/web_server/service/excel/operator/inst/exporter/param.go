...
// GetInstCond get condition for query instance
func (e *InstParam) GetInstCond() (interface{}, error) {
...
// GetInstCond get condition for query instance
func (e *HostParam) GetInstCond() (interface{}, error) {
	if e.cursor == nil {
...
func (e *BizParam) GetInstCond() (interface{}, error) {
	fields := make([]string, 0)
	if len(e.CustomFields) > 0 {
		fields = append(fields, e.CustomFields...)
	...
	if len(e.BizIDArr) > 0 {
		...
		bizCond := &metadata.QueryBusinessRequest{
			BizPropertyFilter: &querybuilder.QueryFilter{
			...
			Fields: fields,
			Page:   e.ExportCond.Page,
		}
		return bizCond, nil
	}

	bizCond := &metadata.QueryBusinessRequest{
		BizPropertyFilter: e.ExportCond.Filter,
		TimeCondition:     e.ExportCond.TimeCondition,
		Fields:            fields,
...
// GetInstCond get condition for query biz
func (e *ProjectParam) GetInstCond() (interface{}, error) {
	fields := make([]string, 0)
	if len(e.CustomFields) > 0 {
		fields = append(fields, e.CustomFields...)
	...
	if len(e.IDArr) > 0 {
		...
		projectCond := &metadata.SearchProjectOption{
