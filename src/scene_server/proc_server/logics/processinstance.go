...
// compareTemplateProperty 通用模板属性比较函数
func compareTemplateProperty[T comparable](templateValue *T, instanceValue *T) bool {
	return (templateValue == nil) != (instanceValue == nil) ||
		(templateValue != nil && instanceValue != nil && *templateValue != *instanceValue)
}
