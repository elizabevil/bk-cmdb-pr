...
// decodeAndValidateProcesses 解码与校验过程
func (ps *ProcServer) decodeAndValidateProcesses(kit *rest.Kit, input *metadata.UpdateRawProcessInstanceInput) (
...
// listProcessRelations 获取进程关系
func (ps *ProcServer) listProcessRelations(kit *rest.Kit, bizID int64, processIDs []int64) (
...
// validateProcessesExist 校验 ProcessID 是否存在
func (ps *ProcServer) validateProcessesExist(kit *rest.Kit, processIDs []int64,
...
// getProcessTemplates 获取模板 Map
func (ps *ProcServer) getProcessTemplates(kit *rest.Kit, relations []metadata.ProcessInstanceRelation) (
	map[int64]*metadata.ProcessTemplate, errors.CCErrorCoder) {
...
// buildProcessUpdateData 构造更新数据
func (ps *ProcServer) buildProcessUpdateData(kit *rest.Kit, input metadata.UpdateRawProcessInstanceInput,
	relations []metadata.ProcessInstanceRelation, processTemplateMap map[int64]*metadata.ProcessTemplate,
...
// batchUpdateProcessInstances 并发批量更新 TODO
