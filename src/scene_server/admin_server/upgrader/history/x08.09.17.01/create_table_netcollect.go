...
var tables = map[string][]types.Index{
	common.BKTableNameNetcollectDevice: []types.Index{
		{Keys: bson.D{{Key: "device_id", Value: 1}}, Background: true},
		{Keys: bson.D{{Key: "device_name", Value: 1}}, Background: true},
		{Keys: bson.D{{Key: "bk_supplier_account", Value: 1}}, Background: true},
	},

	common.BKTableNameNetcollectProperty: []types.Index{
		{Keys: bson.D{{Key: "netcollect_property_id", Value: 1}}, Background: true},
		{Keys: bson.D{{Key: "bk_supplier_account", Value: 1}}, Background: true},
	},
}
