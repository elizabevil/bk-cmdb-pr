...
var tables = map[string][]types.Index{
	common.BKTableNameDynamicGroup: {
		types.Index{Name: "", Keys: bson.D{{Key: common.BKFieldID, Value: 1}}, Background: true, Unique: true},
		types.Index{Name: "", Keys: bson.D{{Key: common.BKAppIDField, Value: 1}, {Key: common.BKFieldID, Value: 1}},
			Background: true},
		types.Index{Name: "", Keys: bson.D{{Key: common.BKAppIDField, Value: 1}, {Key: common.BKFieldName, Value: 1}},
