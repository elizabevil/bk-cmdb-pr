...
var CreateTableOptions = []struct {
...
}{
	{
		...
		TableIndex: []types.Index{
			{Name: "bk_task_id", Keys: bson.D{{Key: "bk_task_id", Value: 1}}, Unique: true, Background: true},
		},
	},
	{
		TableName: common.BKTableNameCloudAccount,
		TableIndex: []types.Index{
			{Name: "bk_account_id", Keys: bson.D{{Key: "bk_account_id", Value: 1}}, Background: true},
		},
	},
	{
		TableName: common.BKTableNameCloudSyncHistory,
		TableIndex: []types.Index{
			{Name: "bk_history_id", Keys: bson.D{{Key: "bk_history_id", Value: 1}}, Background: true},
		},
	},
}
