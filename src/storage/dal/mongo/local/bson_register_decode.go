...
// documentDecodeUseMapStrInterface Whether to enable bson EmbeddedDocument with
// bson Unmarshal value of interface to use map[string]interface object parsing
