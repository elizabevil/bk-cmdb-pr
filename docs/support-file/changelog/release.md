...
**缺陷修复**
- 修复前端切换租户，页面显示业务不存在问题

## [Version: 3.15.1-feature-tenant-alpha19] - 2025-10-29
**功能优化**
- 不开启多租户的场景下从非多租户版本升级数据到多租户版本
- authServer多租户模式适配
- 更新base镜像地址为TencentOS4
- 优化apigw接口文档
- 单租户模式下esb接口适配优化
- 圈复杂度优化
...
## [Version: v3.13.14-alpha1] - 2025-12-15
**功能优化**
- 优化获取中文拼音首字母逻辑
- 升级前端path-to-regexp版本
- 优化安全扫描问题，升级版本依赖

**缺陷修复**
- 前端收藏条件增加基本类型值判断，修复自定义字段分组图标及模型详情下选择修改分组问题
- 使用excel更新主机无权限请求返回错误
- 修复前端主机新增关联失败，实例列表拖拽排序表头及实例名搜索问题
- 修复前端枚举类型字段默认值选择异常的问题
